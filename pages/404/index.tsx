...
const NotFound: NextPage<FC> = () => {
   const [stars, setStars] = useState<Props[]>([]);
   ...
   const generateStars = (count: number): Props[] => {
   ...
   return (
      <div className="relative min-h-screen w-full bg-black text-white flex items-center justify-center">
         ...
         {/* UFO */}
         <div className="ufo">
            <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/8794272-p5k6GdbD8O2RIat5GWtUGJGkDgXoxf.png" alt="UFO" width={300} height={150} />
         </div>
         ...
         <div className="absolute inset-0 flex flex-col items-center justify-center px-4 text-center">
            ...
            <Link href={'/'}>
               <span className="px-6 py-3 text-white bg-purple-600 rounded-lg hover:bg-purple-700">Return Home</span>
            </Link>
         </div>
      </div>
   );
